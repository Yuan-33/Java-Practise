            ...
            <table class="table table-hover table-striped">
                ...
                <c:forEach var="student" items="${requestScope.get('list')}">
                    <tr>
                        ...
                        <td>${student.getStuYear()}</td>
                        <td>
                            <a href="${pageContext.request.contextPath}/student/toUpdateStudent?id=${student.getStuID()}">更改</a> |
                            <a href="${pageContext.request.contextPath}/student/del/${student.getStuID()}">删除</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
